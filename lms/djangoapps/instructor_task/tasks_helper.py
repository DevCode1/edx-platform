...
def push_students_csv_to_s3(_xmodule_instance_args, _entry_id, course_id, task_input, action_name):
    """
    ...
    _get_current_task().update_state(state=PROGRESS, meta={'action_name': action_name})
