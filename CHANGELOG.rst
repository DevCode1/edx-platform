...
Studio: Support adding cohorts from the instructor dashboard. TNL-162

Studio: Support adding students to a cohort via the instructor dashboard. TNL-163

Studio: Show cohorts on the new instructor dashboard. TNL-161
